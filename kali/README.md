# Kali Linux
- Now that we have built our own AD environment, we will now going to pretend to be an attacker and attack our own domain. I will explore four attacks: `AS-REP Roasting`, `Golden Tickets` and `Pass-the-Hash`
